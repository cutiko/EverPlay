...
import {SongAction, UPDATE_PLAYLIST_ROW} from "../actions/actions";

export default function playlistRowsReducer(state: PlaylistRowsState = playlistsRows, action: SongAction): PlaylistRowsState {
  switch (action.type) {
